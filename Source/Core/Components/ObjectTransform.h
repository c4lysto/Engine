...
public:
	...
	virtual Mat34V_Out GetMatrix() const {return Mat34V(I_IDENTITY);}
...
public:
	...
	virtual Mat34V_Out GetMatrix() const override {return Mat34V(I_MAT_POS, m_vPos);}
...
public:
	...
	virtual Mat34V_Out GetMatrix() const override {return m_vTransform;}
	virtual Mat44V_Out GetFullMatrix() const override { return Mat34ToMat44(m_vTransform); }
};
