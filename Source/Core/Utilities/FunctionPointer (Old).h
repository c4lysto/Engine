...
template<typename retType, typename... tArgs>
class StaticFunctionPointer : _FuncPtrBase<retType, tArgs...>
{
...
class MemberFunctionPointer : _FuncPtrBase<retType, tArgs...>
{
...
public:
	...
	FunctionPointer(StaticFunctionPointer<retType, tArgs...>&& rhs)
	{
		m_pFuncWrapper = rhs.CreateCopy();
	}
	...
	template<typename className>
	FunctionPointer(MemberFunctionPointer<retType, className, tArgs...>&& rhs)
	{
		m_pFuncWrapper = rhs.CreateCopy();
	}
	...
	FunctionPointer& operator=(StaticFunctionPointer<retType, tArgs...>&& rhs)
	{
		Clean();
		m_pFuncWrapper = rhs.CreateCopy();
		return *this;
	...
	template<typename className>
	FunctionPointer& operator=(MemberFunctionPointer<retType, className, tArgs...>&& rhs)
	{
		Clean();
		m_pFuncWrapper = rhs.CreateCopy();
		return *this;
