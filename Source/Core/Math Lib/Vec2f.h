...
public:
	...
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eSignBitInitializer,		FloatToIntRep::Sign_Bit)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eAbsMaskInitializer,		FloatToIntRep::Abs_Mask)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTOneInitializer,		1)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTTwoInitializer,		2)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTThreeInitializer,		3)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTFourInitializer,		4)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTFiveInitializer,		5)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTSixInitializer,		6)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTSevenInitializer,		7)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTEightInitializer,		8)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNineInitializer,		9)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTTenInitializer,		10)
	...
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegOneInitializer,		-1)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegTwoInitializer,		-2)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegThreeInitializer,	-3)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegFourInitializer,	-4)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegFiveInitializer,	-5)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegSixInitializer,		-6)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegSevenInitializer,	-7)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegEightInitializer,	-8)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegNineInitializer,	-9)
	DEFINE_VEC2_ENUM_CONSTRUCTOR(eINTNegTenInitializer,		-10)
